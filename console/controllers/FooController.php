	...
	public function actionSms($phone = 18600442970)
	{
		...
		foreach ($ret as $row) {
			...
			QueueUtil::loadJob('sendSMS', [
				'phone' => $phone,
				'msg' => '相约德润英伦时光,一起来脱单吧!时间:8月20日周日下午2:00-5:00;地点:东台市德润5楼英伦时光.形式:8分钟交友,每人跟在场异性聊8分钟,费用:1人参加 60元/人,2人参加(拉单身朋友)50元/人,3人参加40元/人.要求:20-30岁单身男女,在公众号回复我要脱单,客服核查资格后,会及时通知你参加哦',
				'rnd' => 112
			]);
		}
		var_dump(count($ret));
