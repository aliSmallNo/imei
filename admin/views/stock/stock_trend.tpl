    ...
    switch (cat) {
      ...
      case 'new_curr_month_loan':
        ...
        fields = [
          ...
          'new_curr_month_loan_ChenMing_18931357765',
          ...
          'new_curr_month_loan_ZhangMengYing_18410283058',
