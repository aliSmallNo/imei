...
<script>
	...
	function initChart(pid, cat) {
		...
		switch (cat) {
			case 'load':
				names = ["小刀", "金志新", "徐方", '冯林', '陈明', '宋富城', '冯小强', '查俊', "张梦莹", '孙庆海',];// "谢硕硕", "生佳豪", "周攀", "罗文燕", "曹嘉义","王毅龙","于辉",
				fields = [
			...
			case "new":
				...
				fields = ["new_users_ZuoDanLei_18513655687", "new_users_JinZhiXin_18600649492",
