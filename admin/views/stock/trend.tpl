...
<script>
	...
	function initChart(pid, cat) {
		...
		switch (cat) {
			case 'load':
				names = ["小刀", "于辉", "金志新", "徐方", "王毅龙", '冯林', '陈明', '宋富城'];// "谢硕硕", "生佳豪", "周攀", "罗文燕", "曹嘉义",
				fields = [
					...
					, "sum_loan_SongFuCheng_18611794484"
			...
			case "users":
				...
				fields = [
					...
					"sum_loan_users_ChenMing_18931357765", "sum_loan_users_SongFuCheng_18611794484"
