...
<div class="row">
    <form action="/stock/stock_main_rule2" method="get" class="form-inline">
    ...
    <table class="table table-striped table-bordered">
        ...
        {{foreach from=$list item=item}}
            <tr>
                ...
                <td>
                    <div class="{{$item.r_sh_close_60avg_10avg_offset_gt_cls}}">
                ...
                <!-- 上证指数均值/上证涨跌 比例 -->
                <td>
                    <div class="{{$item.r_sh_close_avg_change_rate_gt_cls}}">
                        >{{$item.r_sh_close_avg_change_rate_gt}}</div>
                    <div class="{{$item.r_sh_close_avg_change_rate_lt_cls}}">
                        <{{$item.r_sh_close_avg_change_rate_lt}}</div>
                </td>
                <td>
                ...
                {{if $is_stock_leader}}
                    <td data-id="{{$item.r_id}}" data-r_name="{{$item.r_name}}"
                        ...
                        data-r_sh_turnover_gt="{{$item.r_sh_turnover_gt}}"
                        data-r_sh_turnover_lt="{{$item.r_sh_turnover_lt}}"
                        data-r_diff_gt="{{$item.r_diff_gt}}" data-r_diff_lt="{{$item.r_diff_lt}}"
                        data-r_sh_close_avg_gt="{{$item.r_sh_close_avg_gt}}"
