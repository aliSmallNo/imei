...
<div class="row">
	<h4>推广统计
		<a href="javascript:;" data-images='{{$qrImages}}' class="showQr btn btn-primary btn-xs">我的二维码</a>
	</h4>
</div>
<form action="/site/otherstat" class="form-inline">
...
<script>
	...
	$('.j-scope').click(function () {
		...
		mEndDate.val(edate);
		location.href = "/site/otherstat?sdate=" + sdate + "&edate=" + edate;
	});
