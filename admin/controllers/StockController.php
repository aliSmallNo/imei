...
//		exit;
    ...
    public function actionStock_main_back_r()
    {
        ...
        list($list, $rate_year_sum, $stat_rule_right_rate) = StockMainResult::cal_back_r($price_type, $buy_times,
            $stop_rate);
    ...
    {
        list($list_buy, $list_sold) = StockMainResult::result_stat('2020', '2020');
