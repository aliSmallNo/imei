...
<div class="rank-tab">
	...
	<a href="javascript:;" rank-tag="fans-week">周排行榜</a>
</div>
...
<script data-main="/js/fans-rank.js?v=1.1.8" src="/assets/js/require.js"></script>
<script type="text/template" id="tpl_wx_info">
	{{$wxInfoString}}
</script>
<script type="text/template" id="tpl_fans">
	{[#items]}
	<li>
...
<script type="text/html" id="tpl_fans_top">
	{[#mInfo]}
	<div class="favor-key"></div>
	<div class="favor-avatar"><img src="{[avatar]}"></div>
	<div class="favor-right">
