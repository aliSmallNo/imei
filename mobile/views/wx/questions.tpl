<section id="Q0">
	<div class="que-des">
		<p>
			千寻恋恋是一家<span>东台</span>本地<span>真实的</span>婚恋交友平台，依托微信公众号的功能为广大单身男女提供
			<sapn>找对象</sapn>
			的服务。会员经过严格审核真实可靠，且会员都为东台本地籍贯，更有利于后续的交流。我的独特之处在于引入了媒婆机制，每个单身男女都会有一个<span>媒婆为其进行信用背书</span>写推荐语。从另一方面保证信息的真实性。目前千寻恋恋有两个线上活动正在进行：寻找你<span>最心动的女生</span>活动和<span>答题抽红包</span>活动。欢迎您转发邀请好友一同参加。
		</p>
		<a href="#Q1">开始答题</a>
	</div>
</section>
