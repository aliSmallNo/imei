...
class User extends ActiveRecord
{
	...
	public static function getUsers($condition, $page = 1, $limit = 20)
	{
		...
		foreach ($result as $key => &$v) {
			...
			$v["uEducation"] = isset(self::$edu[$v["uEducation"]]) ? self::$edu[$v["uEducation"]] : "";
			$v["uProfession"] = isset(self::$job[$v["uProfession"]]) ? self::$job[$v["uProfession"]] : "";
			$v["uEstate"] = isset(self::$house[$v["uEstate"]]) ? self::$house[$v["uEstate"]] : "";
			...
			$v["uFitness"] = isset(self::$workout[$v["uFitness"]]) ? self::$workout[$v["uFitness"]] : "";
			$v["uBrief"] = isset(self::$belief[$v["uBrief"]]) ? self::$belief[$v["uBrief"]] : "";
			$v["uSmoke"] = isset(self::$smoke[$v["uSmoke"]]) ? self::$smoke[$v["uSmoke"]] : "";
			$v["uAlcohol"] = isset(self::$drink[$v["uAlcohol"]]) ? self::$drink[$v["uAlcohol"]] : "";
