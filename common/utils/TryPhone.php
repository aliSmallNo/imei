...
//				$ret = self::reqData($data, $cat, $header, 1);
	...
	public static function phone_section_1()
	{
		...
		$phone_section = [
			1561102, 1391026, 1891113, 1861815, 1372004, 1851048, 1305191, 1381198, 1368365,
	...
	public static function phone_section_2()
	{
		...
		$phone_section = [
			//1375220,
			1361208, 1392069, 1351622, 1860226, 1512216, 1863099, 1552293, 1852236, 1592208,
	...
	{
		$phone_section = [
			1851365, 1825157, 1395925, 1874207, 1881145, 1521009, 1551069, 1863116, 1397886, 1581156, 1511795,
